...
{
    return GetBoolArg("-testnet", false) ? 19124 : 29124;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop Infocoin server (and possibly override the detachdb config value).");
